...
//pe-roll
import PeRollHome from "./pages/PeRollHome";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/pe-roll"
          element={<PrivateRoute><PeRollHome /></PrivateRoute>}
        />

        {/* Parameter Settings */}
        <Route
          path="/pe-roll/parameter-settings"
          element={<PrivateRoute><ParameterSettings /></PrivateRoute>}
        />

        {/* Employee Registration */}
        <Route
          path="/pe-roll/employee-registration"
          element={<PrivateRoute><EmployeeRegistration /></PrivateRoute>}
        />
        ...
        {/* Daily Records (Rajani Vigat) */}
        <Route
          path="/pe-roll/daily-records"
          element={<PrivateRoute><DailyRecords /></PrivateRoute>}
        />

        {/* Qualification Details (Upadni Vigat) */}
        <Route
          path="/pe-roll/qualification-details"
          element={<PrivateRoute><QualificationDetails /></PrivateRoute>}
        />

        {/* PF Management */}
        <Route
          path="/pe-roll/pf-management"
          element={<PrivateRoute><PFManagement /></PrivateRoute>}
        />

        {/* Salary Sheet */}
        <Route
          path="/pe-roll/salary-sheet"
          element={<PrivateRoute><SalarySheet /></PrivateRoute>}
        />
